...
function getTranslate()
{
    $data = array(
        ...
        'Select Industry' => 'Chọn Ngành Nghề',
        'Select Department' => 'Chọn Phòng Ban',

        "Metal Processing"    => "Gia công kim loại",
        "Automotive Parts"    => "Phụ tùng linh kiện xe",
        "Plastic Injection"   => "Ép nhựa",
        "Rubber"              => "Cao su",
        "Electronic Parts"    => "Linh kiện điện tử",
        "Wooden Furniture"    => "Nội thất gỗ",
        "F&B"                 => "F&B (Thực phẩm & Đồ uống)",
        "Textiles and Garments" => "Dệt may",
        "Shoes and Leather"       => "Giày, da",
        "Packaging"           => "Bao bì",
        "Wires and Fiber Optics"  => "Dây điện, cáp quang",
        "Pharmaceuticals"     => "Dược phẩm",
        "Chemicals"           => "Hóa chất",
        "Machinery Manufacturing" => "Chế tạo máy",
        "IoT and Automation"      => "IoT/Tự động hóa",
        "IT"                  => "IT (Công nghệ thông tin)",
        "Associations"        => "Hiệp hội",
        "Services"            => "Dịch vụ",
        "Other Manufacturing" => "Sản xuất khác",
        "Other"               => "Khác",
        ...
        "IT"                     => "IT (Công nghệ thông tin)",
        "HR"                     => "HR (Nhân sự)",
        "Import and Export"      => "XNK (Xuất nhập khẩu)",
        "Other"                  => "Khác",
