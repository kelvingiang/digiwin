                    ...
                    <div class="col">
                        ...
                        <div class="cell-text">
                            <input type="text" name="txt-name-cn" id="txt-name-cn" class="my-input"
                                   value="<?php echo get_post_meta($post->ID, '_active_name_cn', true) ?>" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="cell-text">
                            <input type="text" name="txt-name-vn" id="txt-name-vn" class="my-input"
                                   value="<?php echo get_post_meta($post->ID, '_active_name_vn', true) ?>" />
                        </div>
                    </div>
                </div>
                <div class="row-one-column">
                    ...
                    <div class="col">
                        ...
                        <div class="cell-text">
                            <input type="text" name="txt-name-en" id="txt-name-en" class="my-input"
                                   value="<?php echo get_post_meta($post->ID, '_active_name_en', true) ?>" />
                        </div>
                    </div>
                </div>
                <div class="row-one-column">
