...
class Metabox_Service {
    ...
    public function save($post_id) {
        ...
        update_post_meta($post_id, '_service_name_cn', sanitize_text_field(wp_unslash($_POST['txt-name-cn'])));
        update_post_meta($post_id, '_service_content_cn', sanitize_text_field(wp_unslash($_POST['txt-content-cn'])));

        update_post_meta($post_id, '_service_name_vn', sanitize_text_field(wp_unslash($_POST['txt-name-vn'])));
        update_post_meta($post_id, '_service_content_vn', sanitize_text_field(wp_unslash($_POST['txt-content-vn'])));

        update_post_meta($post_id, '_service_name_en', sanitize_text_field(wp_unslash($_POST['txt-name-en'])));
        update_post_meta($post_id, '_service_content_en', sanitize_text_field(wp_unslash($_POST['txt-content-en'])));
    }
