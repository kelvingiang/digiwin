<div class="side-right">
    <div class="side-right-close">
        <svg class="icon-style" style="width: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
            <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z" />
        </svg>
    </div>
    <div class="side-right-content">
        <!-- <div class="item-user">
            <a href="<?php //echo WP_HOME . '/member/' ?>">
                <svg class="icon-style" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
        ...
        <div class="item-hotline">
            <svg class="icon-style" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        ...
        <div class="item-download">
            <svg class="icon-style" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1 34.1L269.7 378.3c-7.5 7.5-19.8 7.5-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24c0-13.3 10.7-24 24-24zm296 376v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3 10.7-24 24-24h146.7l49 49c20.1 20.1 52.5 20.1 72.6 0l49-49H488c13.3 0 24 10.7 24 24zm-124 88c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20zm64 0c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20z" />
            </svg>
        </div>

        <div class="item-zalo">
            <svg class="icon-style" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div class="zalo-code">
                <img alt="digiwin zalo" src="<?php echo PART_IMAGES . 'zalo-qrcode.jpg'; ?>" loading="lazy" width="100" height="100" />
            </div>
        </div>
        <div>
            <div>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery('.item-download').on('click', function() {
            window.location = "<?php echo WP_HOME . '/contact-vn/#infocard'; ?>";
        });
    });
</script>