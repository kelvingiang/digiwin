<?php
$like_count = (int) get_post_meta($post->ID, '_metabox_like', true);
?>
    ...
    <div class="view_like_content">
        ...
        <div>
            ...
            <div class="like-click">
                <svg class="icon-comment" data-count="<?php echo $like_count ?>" data-post="<?php echo $post->ID ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery(document).on('click', '.like-post', function() {
            // khi click vào like sẽ thật hiên số like tăng một và remove class cho phép rồi mới tiền hành update số lượt like và database =============================================================================================
            var $this = jQuery(this);
            var currentCount = parseInt($this.attr("data-count")) || 0;
            var newCount = currentCount + 1;
            jQuery('.like-count').html(newCount);
            $this.removeClass('like-post');


            // tiến hành update đến database =============================================================
            jQuery.ajax({
